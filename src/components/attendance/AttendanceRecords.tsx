...
export default function AttendanceRecords() {
  ...
  }, [codeCreatedAt, codeEnabled, weekNumber]);
          ...
          <div style={{display: 'flex', alignItems: 'center', gap: '12px'}}>
            ...
            <div>
              ...
              <p style={{margin: '4px 0 0', color: '#8a9e94', fontSize: '13px'}}>
                {codeEnabled ? '学生需要输入验证码才能点名 (每10分钟自动刷新)' : '验证码功能已关闭'}
              </p>
            </div>
          </div>
              ...
              <div style={{
                ...
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '4px'}}>
                  ...
                  {codeExpiresIn !== null && (
                    <div style={{
                      fontSize: '11px',
                      color: codeExpiresIn < 2 ? '#ff7b72' : codeExpiresIn < 5 ? '#ffa657' : '#13ec80',
                      fontWeight: 600,
                      marginLeft: '12px',
                    }}>
                      {codeExpiresIn < 0.1 ? '已过期' : `${Math.floor(codeExpiresIn)}分${Math.floor((codeExpiresIn % 1) * 60)}秒后失效`}
                    </div>
                  )}
                </div>
